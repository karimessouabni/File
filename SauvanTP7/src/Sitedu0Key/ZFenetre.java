...
public class ZFenetre extends JFrame {
  ...
  public ZFenetre(){
    ...
    this.test1.add(item1); // Fichier Ouvrire
 
    //On ajoute les éléments dans notre sous-menu
    this.test1_2.add(jcmi1);//Sous ficher Choix 1
    this.test1_2.add(jcmi2);//Sous ficher Choix 2
    //Ajout d'un séparateur
    this.test1_2.addSeparator();//Sous ficher separe
    ...
    this.test1_2.add(jrmi1); // radio 1
    this.test1_2.add(jrmi2); // radio 2
 
    //Ajout du sous-menu dans notre menu
    this.test1.add(this.test1_2);
    //Ajout d'un séparateur
    this.test1.addSeparator();
    item2.addActionListener(new ActionListener(){ // classe anonyme 
      public void actionPerformed(ActionEvent arg0) {
        System.exit(0);
      }        
    });
    this.test1.add(item2); // fermer  
    this.test2.add(item3); // lancer
