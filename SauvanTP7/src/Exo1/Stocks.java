...
public class Stocks implements Serializable {
     ...
     */
    public static void loadStocks(BackupManager backupManager) {
        instance = (Stocks) backupManager.loadBackup();
    }
    /**
     ...
     * @param The backup manager to use.
     */
    public static void saveStocks(BackupManager backupManager) {
        backupManager.saveBackup(instance);
    }
