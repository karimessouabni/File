...
public class MediaStoreNavigator extends JFrame {
    ...
    public MediaStoreNavigator(String path) {
        super("MediaStore");
        fc = new JFileChooser(); // une seule instance pour se souvenir du dernier répertoire ouvert
        ...
        JOptionPane.showMessageDialog(MediaStoreNavigator.this, "Chargement initial de l’état des stocks effectué !");

        // pour  que  la première ouverture du JFileChooser se fera dans le repertoire du chargement initial de l'état des stocks
        File f = null;
        try {
        ...
        this.tabs.setSelectedIndex(0); // //or this.tabs.setSelectedIndex(MediaStoreNavigator.this.tabs.indexOfTab("Stocks"));
    ...
    private void addMenuBar() {
        ...
        menuItem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int indexStocksTab = MediaStoreNavigator.this.tabs.indexOfTab("Stocks"); // the tab(Stocks) opened's index (if there is one of course)
                ...
                MediaStoreNavigator.this.tabs.setSelectedIndex(indexStocksTab);// if the tab is opened 
            }
        });
        ...
        menuItem = new JMenuItem(new DefaultEditorKit.CutAction()); // the same for this.quitAction
    ...
    private void makeStocksTab() {
        ...
        TableColumn nbrPdCol = this.stocksTable.getColumn("Nombre de produits"); // pick up the instance of TableColumn associated
        ...
        this.stocksTable.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if ((e.getButton() == MouseEvent.BUTTON1) && (e.getClickCount() == 2) && !e.isConsumed()) {
                    ...
                    if ((column == 0) && (row >= 0)) { //==0 for the reference column and >=0 for the Stock
    ...
    /**
     * @param reference
     * it opens a Product Tab ( from the search text field or a right double clique on a reference in the StocksTab)  
     */
    ...
    private class CloserTabAction extends AbstractAction {
        ...
        @Override
        public void actionPerformed(ActionEvent e) {
            MediaStoreNavigator.this.tabs.remove(MediaStoreNavigator.this.tabs.getSelectedIndex()); // ferme l'onglet actif
        }
    }
    ...
    private class SpinnerChooserEditor extends AbstractCellEditor implements TableCellEditor {
    	...
    	private int col ;
    	  public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected,
    		  ...
    		  this.row=row;this.col=column;
    		    ...
    		    int max = 1000;
    		    int step = 1;
    		    int initValue =  (int) MediaStoreNavigator.this.st.getValueAt(row, column);
    	  ...
    	  public int getValueAt(int row, int column) {
    		    return (int) MediaStoreNavigator.this.st.getValueAt(row, column); 
    		  }
    	  
    	  public void setValueAt(Object value, int row, int column) {
    		  MediaStoreNavigator.this.st.setValueAt( value, row, column);
    		  }
		...
		/*	class SpinnerListener implements ChangeListener {
			  public void stateChanged(ChangeEvent evt) {
			    ...
			    int newV = (int)value ;
			    MediaStoreNavigator.this.st.setValueAt(newV, SpinnerChooserEditor.this.row, SpinnerChooserEditor.this.col);
