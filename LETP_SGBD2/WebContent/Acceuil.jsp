...
<html><head></head><body style="">&lt;%-- 
    ...
    Created on : 5 mai 2013, 14:12:06
    Author     : Bouzidi
--%&gt;
...
&lt;%@page contentType="text/html" pageEncoding="UTF-8"%&gt;
        ...
        <form id="RegisterUserForm" action="Registration?function=getRegistration" method="post">
            ...
            <input id="familyname" name="familyname" type="text"><br><br>
            <label for="age">Birthday date*:</label><br>
            ...
            <select name="birthday_year" id="birthday_year" aria-label="Ann�e">
            ...
            <input id="cfpassword" name="cfpassword" type="password"><br><br>

            <input class="submitButton" type="submit" name="Submit" value="Register"> <br><br>
